  ...
  head: () => ({
    meta: [
      ...
      { title: "Oro Barbershop — Parturi Norkkokuja 3" },
      {
        name: "description",
        content:
          "Oro Barbershop Norkkokuja 3. Laadukkaat hiustenleikkuut ja parranajot. Ajanvaraus puhelimitse 041 796 2012 tai walk-in.",
      },
      { property: "og:title", content: "Oro Barbershop — Parturi Norkkokuja 3" },
      {
        property: "og:description",
        content:
          "Laadukkaat hiustenleikkuut ja parranajot. Ajanvaraus: 041 796 2012 tai walk-in.",
      },
